...
A server's emissions come from two sources: the carbon embodied in manufacturing it, and the carbon emitted while it runs. These frequently pull against each other. Keeping older hardware in service avoids new manufacturing emissions, but that hardware is less energy efficient, so its footprint is increasingly operational. Much of my work is about characterizing that tradeoff and designing systems that account for both sides of it rather than optimizing one in isolation.
...
* <span class="icon-list__icon" aria-hidden="true">🍽️</span> I love making, talking about, and eating food. I may ask you questions such as "what fruit do you think is underrated?"<span id="fruit-verdict" hidden> (<span id="fruit-verdict-text"></span>, according to my <a href="#survey">very scientific survey</a>)</span>. I apologize in advance. If you haven't had the privilege of being asked in person, [take the opportunity to be asked virtually](https://forms.gle/NiYerAvgQ5JkidE5A).
